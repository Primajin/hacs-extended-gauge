...
export class ExtendedGauge extends LitElement 
{
  ...
  @property({ type: String }) public needleStyle?: "default" | "classic" | "icon" | "none";
  ...
  protected render() 
  {
    ...
    return html`
      ...
      <g transform="translate(15 5)">
        <path 
          style =${styleMap({ stroke: `${this.segments && showNeedleEffective? this.gaugeInfoColor : this.gaugeBackgroundColor}` })}
          class="dial"
        ...
        ${
          this.segments && showNeedleEffective
            ...
            svg `<path
                ...
                style =${styleMap({ stroke: `${gaugeValueColor}`, strokeDasharray: `${pathLength}`, strokeDashoffset: `${dashOffset}` })}
                d="M -40 0 A 40 40 0 0 1 40 0">
            </path>
            `
          }
