    ...
    `}}(e);default:return yt(e)}}({needleStyle:this.needleStyle,needleIcon:this.needleIcon,needleIconPath:this._needleIconPath,needleIconKeepVertical:this.needleIconKeepVertical,needleIconSize:this.needleIconSize,needleIconColor:this.needleIconColor,needleIconBackgroundColor:this.needleIconBackgroundColor,valueAngle:this._valueAngle,animate:this._updated&&this.animation})}render(){this._normalizeSegments();const e=Object.assign({},this.formatOptions);e.thousandSeparator="";let t=this.gaugeInfoColor;this.segments&&!this.showSegments&&this.segments.slice().sort(((e,t)=>e.lower-t.lower)).forEach((e=>{this.value>=e.lower&&this.value<=e.upper&&(t=e.color)}));const i=this.showDial,n=125.664,o=n-n*this._valueAngle/180,s=this.useGradient&&this.segments&&this.segments.length>0,r=s?this.segments.slice().sort(((e,t)=>e.lower-t.lower)):[];return R`
      ...
      ${s?j`
            <defs>
              <linearGradient id="segment-gradient" gradientUnits="userSpaceOnUse" x1="-40" y1="0" x2="40" y2="0">
                ${r.map((e=>{const t=this._getLowerAngle(e.lower,this.min,this.max),i=(1-Math.cos(t*Math.PI/180))/2*100;return j`<stop offset="${i}%" stop-color="${e.color}" />`}))}
              </linearGradient>
            </defs>
          `:""}
      <g transform="translate(15 5)">
        ...
        ${this.segments&&this.showSegments?this.segments.slice().sort(((e,t)=>e.lower-t.lower)).map((e=>{const t=this._getLowerAngle(e.lower,this.min,this.max),i=this._getUpperAngle(e.upper,this.min,this.max);return j`
                  <path
                      stroke="${s?"url(#segment-gradient)":e.color}"
                      class="segment"
                      d="M
          ...
          ${i?j`<path
                ...
                style =${$e({stroke:`${s?"url(#segment-gradient)":t}`,strokeDasharray:"125.664",strokeDashoffset:`${o}`})}
                d="M -40 0 A 40 40 0 0 1 40 0">
            </path>
            `:""}
      ...
      <ha-card style="text-align: center !important;">
        ...
        <div class="card-content-container">
          <microteq-extended-gauge
            ...
            .useGradient=${null===(N=H.main)||void 0===N?void 0:N.use_gradient}
            .segments=${this._convertSegments(H)}
            .showSegmentLabels=${null===(M=H.main)||void 0===M?void 0:M.show_segment_labels}
